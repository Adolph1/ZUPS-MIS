 ...
 * @property integer $zups_pension_type
 * @property integer $blood_group_id
 * @property integer $aina_ya_msaidizi
 * @property integer $aliyechukua_finger
 * @property integer $tarehe_ya_finger
 *
...
class Mzee extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['fomu_namba', 'majina_mwanzo', 'jina_babu', 'jinsia','mchukua_taarifa_id', 'tarehe_kuzaliwa', 'mzawa_zanzibar', 'aina_ya_kitambulisho', 'nambar', 'mkoa_id', 'wilaya_id', 'shehia_id',  'njia_upokeaji', 'pension_nyingine','zups_pension_type'], 'required'],
            ...
            //  [['mzee_picha','msaidizi_picha'],'file', 'skipOnEmpty' => false,'extensions' => 'jpeg,jpg, gif, png'],
            //[['nambar',], 'unique'],
