...
class Mzee extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['majina_mwanzo', 'jina_babu', 'jinsia','mchukua_taarifa_id', 'tarehe_kuzaliwa', 'mzawa_zanzibar', 'mkoa_id', 'wilaya_id', 'shehia_id',  'njia_upokeaji','zups_pension_type'], 'required','on' => 'create'],
