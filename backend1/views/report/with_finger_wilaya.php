...
<div class="mzee-index">
    ...
    <div class="row">
        <div class="col-md-12">
            <strong class="lead"  style="color: #01214d;font-family: Tahoma"> <i class="fa fa-check-square text-green"></i> ZUPS - ORODHA YA WAZEE WALIOCHUKULIWA FINGER PRINT KIWILAYA</strong>
        </div>
    ...
    $pdfHeader = [
        ...
        'C' => [
            'content' => 'WAZEE WALISAJILIWA FINGER PRINT NA ASILIMIA ZAO KIWILAYA',
            'font-size' => 10,
            'font-style' => 'B',
            'font-family' => 'arial',
            'color' => '#333333'
    ...
    $gridColumns = [
        ...
        [
            ...
            'filter' => ArrayHelper::map(\backend\models\Wilaya::find()->orderBy('id')->asArray()->all(), 'id', 'jina'),
            'filterWidgetOptions' => [
    ...
    'export' => [
        ...
        'exportConfig' => [
            GridView::PDF => [
                ...
                'showCaption' => true,
                'filename' => Yii::t('kvgrid', 'Zups Finger Prints ripoti'),
