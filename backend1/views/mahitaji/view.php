...
$this->title = $model->hitaji;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Mahitajis'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="mahitaji-view">


    <hr/>
    <div class="row">
        <div class="col-md-6">
            <strong class="lead"  style="color: #01214d;font-family: Tahoma"> <i class="fa fa-check-square text-green"></i> ZUPS - HITAJI</strong>
        </div>
        <div class="col-md-2">
