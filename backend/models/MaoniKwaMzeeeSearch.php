...
/**
 * MaoniKwaMzeeeSearch represents the model behind the search form about `backend\models\MaoniKwaMzee`.
 */
class MaoniKwaMzeeeSearch extends MaoniKwaMzee
{
    /**
     * @inheritdoc
     */
