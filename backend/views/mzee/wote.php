    ...
    <div class="mzee-index">
        ...
        <div class="row">
            <div class="col-md-6">
                <strong class="lead" style="color: #01214d;font-family: Tahoma"> <i
                            class="fa fa-check-square text-green"></i> ZUPS - ORODHA YA WAZEE </strong>
            </div>
            <div class="col-md-2">
        ...
        $gridColumns = [
            ...
            [
                ...
                'vAlign' => 'middle',
                'width' => '120px',
                'filter' => \backend\models\Mzee::getAnaishiStatus(),
                'value' => function ($model) {
                    if ($model->anaishi == \backend\models\Mzee::ELIGIBLE) {

                        return 'NDIYO';
                    } elseif ($model->anaishi == \backend\models\Mzee::DIED) {
                        return 'HAPANA';
                    } else {
                        return '';
                    }
            ...
            [
                ...
                'value' => function ($model) {
                    if ($model->status == \backend\models\Mzee::ELIGIBLE) {

                        return 'AMEKUBALIWA';
                    } elseif ($model->status == \backend\models\Mzee::SUSPENDED) {
                        return 'AMESIMAMISHWA';
                    } elseif ($model->status == \backend\models\Mzee::VETTED) {
                        return 'ANASUBILI UHAKIKI';
                    } elseif ($model->status == \backend\models\Mzee::PENDING) {
                        return 'HAJAHAKIKIWA';
