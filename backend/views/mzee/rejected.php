...
<div class="mzee-index">
    ...
    <div class="row">
        <div class="col-md-6">
            <strong class="lead"  style="color: #01214d;font-family: Tahoma"> <i class="fa fa-check-square text-green"></i> ZUPS - ORODHA YA WAZEE WALIOKATALIWA MAOMBI</strong>
        </div>
        <div class="col-md-2">
    ...
    echo GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '',
            'before' => '<span class ="text text-red">* Waliokataliwa*</span>'
        ],
        'persistResize' => false,
