    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    <?= $form->field($model, 'department_id')->dropDownList(\backend\models\Department::getALl(),['prompt' => '--Chagua idara--']) ?>
                </div>
            </div>

            <div class="row">
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    <?= $form->field($model, 'report_to')->dropDownList(\backend\models\Kazi::getAll(),['prompt' => '--Chagua Kazi--']) ?>
                </div>
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
