...
<div class="department-index">
    ...
    <div class="row">
        <div class="col-md-6">
            <strong class="lead"  style="color: #01214d;font-family: Tahoma"> <i class="fa fa-check-square text-green"></i> ZUPS - DEPARTMENT MPYA</strong>
        </div>
           ...
           [
                   'attribute' => 'parent_department',
                    'value' => function ($model){
                        if($model->parent_department == null){
                            return '';
                        }else {
                            return $model->parent->jina;
                        }
                    }
           ],
           //'parent_department',
