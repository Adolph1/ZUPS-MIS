    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="statement-table" style="margin-left: 10px;">
            ...
            echo '<table class="table table-condensed">';
                echo '<tr><th>Date</th><th>Reference</th><th>Description</th><th>Debit</th><th>Credit</th></tr>';
                ...
                echo '<tr>';
                    ...
                    if($statement->drcr_ind=='D'){
                    echo '<td>'.$fmt->asDecimal($statement->amount,2).'</td>';
                    echo '<td>0.00</td>';;
                    }elseif ($statement->drcr_ind=='C'){
                    echo '<td>0.00</td>';
                    echo '<td>'.$fmt->asDecimal($statement->amount,2).'</td>';
                    }
                    echo '</tr>';
