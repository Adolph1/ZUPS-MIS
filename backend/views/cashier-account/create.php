...
$this->title = Yii::t('app', 'Create Cashier Account');
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Cashier Accounts'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="cashier-account-create">

    <hr/>
    <div class="row">
        <div class="col-md-6">
            <strong class="lead"  style="color: #01214d;font-family: Tahoma"> <i class="fa fa-check-square text-green"></i> ZUPS - AKAUNTI MPYA</strong>
        </div>
        <div class="col-md-2">
