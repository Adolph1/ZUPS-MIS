...
<div class="mzee-index">
    ...
    <div class="row">
        <div class="col-md-6">
            <strong class="lead"  style="color: #01214d;font-family: Tahoma"> <i class="fa fa-check-square text-green"></i> ZUPS - ORODHA YA WAZEE WALIOSAJILIWA</strong>
        </div>
        <div class="col-md-2">
    ...
    echo GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => 'Orodha ya wazee waliosajiliwa katika shehia mbalimbali',
            'before' => '<span class ="text text-orange">* Wanaosubiri uhakiki wa taarifa zao *</span>'
        ],
        'persistResize' => false,
