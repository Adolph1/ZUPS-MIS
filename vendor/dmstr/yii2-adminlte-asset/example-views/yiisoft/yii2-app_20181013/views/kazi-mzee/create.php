...
$this->title = Yii::t('app', 'Kazi Mpya');
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Kazi Za wazee'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="kazi-mzee-create">

    <hr/>
    <div class="row">
        <div class="col-md-6">
            <strong class="lead"  style="color: #01214d;font-family: Tahoma"> <i class="fa fa-check-square text-green"></i> ZUPS - KAZI MPYA</strong>
        </div>
        <div class="col-md-2">
