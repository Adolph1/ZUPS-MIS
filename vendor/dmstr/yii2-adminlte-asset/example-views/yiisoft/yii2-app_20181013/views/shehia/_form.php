...
<div class="shehia-form">
    ...
    <?= $model->isNewRecord ? $form->field($model, 'sheha_id')->dropDownList(['prompt' => '--Chagua Sheha--']) : $form->field($model, 'sheha_id')->dropDownList(\backend\models\Sheha::getALl(),['prompt' => '--Chagua Sheha--']) ?>
