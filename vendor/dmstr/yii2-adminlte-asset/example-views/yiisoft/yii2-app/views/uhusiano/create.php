...
$this->title = Yii::t('app', 'Create Uhusiano');
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Uhusianos'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="uhusiano-create">


    <hr/>
    <div class="row">
        <div class="col-md-6">
            <strong class="lead"  style="color: #01214d;font-family: Tahoma"> <i class="fa fa-check-square text-green"></i> ZUPS - UHUSIANO MPYA</strong>
        </div>
        <div class="col-md-2">
