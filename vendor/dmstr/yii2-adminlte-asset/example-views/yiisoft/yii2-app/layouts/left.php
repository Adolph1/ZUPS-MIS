                        ...
                        [
                            ...
                            'items' => [
                                ...
                                [
                                 ...
                                 ['label' => 'Bakaa ya budget',  'visible' => Yii::$app->user->can('viewBudgetBalance'), 'icon' => 'circle text-blue', 'url' => ['/budget-monthly-balance/index'],],
                                [
                                ...
                                [
                                    ...
                                    'items' => [
                                        ...
                                        ['label' => 'Print vouchers', 'visible' => Yii::$app->user->can('printVoucher'), 'icon' => 'print text-blue', 'url' => ['/voucher/kituo-voucher'],],
