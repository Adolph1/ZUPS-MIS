            ...
            [
                ...
                "items" => [
                    ...
                    [
                        ...
                        'url' => '#',
                        'items' => [
                            ['label' => 'Uendeshaji Budget Mpya',  'visible' => Yii::$app->user->can('admin') || Yii::$app->user->can('createBudget'), 'icon' => 'circle text-blue', 'url' => ['/budget/create'],],
                            [
                                    'label' => 'Orodha ya Uendeshaji Budgets',
                                    'icon' => 'circle text-blue',
                    ...
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'url' => '#',
                                'items' => [
                                    ['label' => 'Malipo ya wazee ',  'icon' => 'file-o', 'url' => ['/report/kiwilaya'],],
                                    ['label' => 'Malipo ya watendaji',  'icon' => 'file-o', 'url' => ['/report/kimkoa'],],
                                    ['label' => 'malipo maofisa',  'icon' => 'file-o', 'url' => ['/report/new-dead'],],
                                    ['label' => 'malipo bidhaa',  'icon' => 'file-o', 'url' => ['/report/new-dead'],],
                            ...
                            [
                                ...
                                'url' => '#',
                                'items' => [
                                    ['label' => 'Wenye finger print kiwilaya',  'icon' => 'file-o', 'url' => ['report/with-finger-district'],],
                                    ['label' => 'Wenye finger print kwa kituo',  'icon' => 'file-o', 'url' => ['report/with-finger-kituo'],],
