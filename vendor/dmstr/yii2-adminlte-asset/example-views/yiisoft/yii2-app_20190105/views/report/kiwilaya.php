        ...
        $gridColumns = [
            ...
            [
                ...
                'value' => function($model){
                    ...
                    return \backend\models\Malipo::getCountPerKiwilaya($model->id);
            ...
            [
                ...
                'value' => function($model){
                    ...
                    return \backend\models\Malipo::getCountPerKiwilayaPaid($model->id);
            ...
            [
                ...
                'value' => function($model){
                    ...
                    return \backend\models\Malipo::getCountPerKiwilayaPending($model->id);
            ...
            [
                ...
                'value' => function($model){
                    ...
                    return \Yii::$app->formatter->asDecimal((100*\backend\models\Malipo::getCountPerKiwilayaPaid($model->id)/\backend\models\Malipo::getCountPerKiwilaya($model->id)),2);
            ...
            [
                ...
                'value' => function($model){
                    ...
                    return \backend\models\KituoMonthlyBalances::getBalancePerKiwilaya($model->id);
            ...
            [
                ...
                'value' => function($model){
                    ...
                    return \backend\models\KituoMonthlyBalances::getBalancePerKiwilayaPaid($model->id);
            ...
            [
                ...
                'value' => function($model){
                    ...
                    return \backend\models\KituoMonthlyBalances::getBalancePerKiwilayaBalance($model->id);
        ...
        $gridColumns = [
            ...
            [
                ...
                'value' => function($model){
                    ...
                    return (100*\backend\models\Malipo::getCountPerKiwilayaPaid($model->id)/\backend\models\Malipo::getCountPerKiwilaya($model->id)).'%';
